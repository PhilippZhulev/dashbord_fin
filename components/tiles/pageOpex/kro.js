...
'                                        <div class="row">' +
'                                            <div class="col-12">' +
'                                                <span class="tiles__wrapper__tile_title">Категории расходов OPEX<span>млрд. руб</span></span>' +
'                                                <button type="button" class="btn btn-outline-info btn-open-modal btn-sm btn-kro" data-target="kro" data-title="Категории расходов OPEX">' +
...
'                                                   </svg>' +
'                                                </button>' +
'                                                <button type="button" class="btn btn-outline-info btn-abc btn-sm btn-ref">ABC -> %</button>' +
'                                            </div>' +
'                                        </div>' +
'                                    </div>' +
...
'                                                </div>' +
'                                                <div class="col-2">' +
'                                                    <span class="collapse__table__title">Отклонение</span>' +
'                                                </div>' +
'                                            </div>' +
'                                        </div>' +
...
'                                </div>'
        ...
        globals.navigation({
            ...
            page : ".p_staff",
            callback: function () {
                globalSettings.Settings.result = ".p_staff";
        ...
        globals.navigation({
            ...
            page : ".p_allokaciya", 
            callback: function () {
                globalSettings.Settings.result = ".p_allokaciya";
                globalSettings.that_c.firePropertiesChangedAndEvent(["SettingsTP"], "tech1");
            }
        });
