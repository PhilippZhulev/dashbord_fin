    ...
    this.readData = function(a) {
        ...
        {   
                ...
                '                                                        <span class="tiles__wrapper__tile_title_small">'+incoming_data[i].category+'</span>' +
                    '                                                    <button type="button" class="btn-open-modal my_super_info_btn" data-target="'+incoming_data[i].text1+'" data-title="'+incoming_data[i].category+'" data-middle="true"></button>' +
