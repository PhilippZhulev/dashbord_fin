        ...
        document.addEventListener("dash.update", function(event) {
           // event.stopPropagation(); event.preventDefault();
            var back = document.querySelector(".back_btn"),
                ...
                lanchBack = document.querySelector(".back_lanch_btn");
            ...
            if(globals.page !== ".p_main") {
                ...
                lanchBack.classList.remove("active");
            }
            else {
                lanchBack.classList.add("active");
            ...
            switch (globals.page) {
                ...
                case ".p_allokaciya2" : globals.title = "Правила аллокации"; globals.title_group_bank = "Группа"; break;
            }
            ...
            globals.navigation({
                ...
                callback: function () {
                    ...
                    globals.prevPage = [];
                    globalSettings.Settings.result = ".p_main";
            ...
            globals.navigation({
                ...
                callback: function () {
                    ...
                    globalSettings.Settings.result = globals.prevPage.slice(0, -2);
                    globalSettings.that_c.firePropertiesChangedAndEvent(["SettingsTP"], "tech1");
                }
            });
...
'                       </svg>' +
'                    </div>' +
'                    <div class="back_lanch_btn active">'+
'                       <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">' +
'                           <path fill="#fff" d="M2.117 12l7.527 6.235-.644.765-9-7.521 9-7.479.645.764-7.529 6.236h21.884v1h-21.883z"/>' +
'                       </svg>' +
'                    </div>' +
...
'                  <b class="pages_title">' +
                      globals.title +
'                  </b>' +
'                  <div class="navigation_block_right">' +
...
'                    </div>' +
'                    <div class="filters_block__item">' +
'                        <span class="filters_block__title">Сравнение</span>' +
'                        <div class="filters_block__input">' +
'                            <div class="custom_select period">' +
...
'            </div>'
        ...
        globals.tap(document.querySelector(".back_lanch_btn"), function (e){
